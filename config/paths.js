...
const resolveHTML = () => {
    switch (envEntryPoint) {
		case 'ss':
		default:
			return resolveApp('public/ss/index.html');
	}
};
...
const resolveIndex = () => {
    switch (envEntryPoint) {
		case 'ss':
		default:
			return resolveModule(resolveApp, 'src/ss/index');
	}
};
